...
export const sectorHexagonPlane = {
  unclaimed: new MeshBasicMaterial({ color: factionColors.unclaimed.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  xen: new MeshBasicMaterial({ color: factionColors.xen.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  arg: new MeshBasicMaterial({ color: factionColors.arg.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  ant: new MeshBasicMaterial({ color: factionColors.ant.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  hat: new MeshBasicMaterial({ color: factionColors.hat.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  par: new MeshBasicMaterial({ color: factionColors.par.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  hop: new MeshBasicMaterial({ color: factionColors.hop.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  tel: new MeshBasicMaterial({ color: factionColors.tel.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  zya: new MeshBasicMaterial({ color: factionColors.zya.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  frf: new MeshBasicMaterial({ color: factionColors.frf.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  ter: new MeshBasicMaterial({ color: factionColors.ter.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  pio: new MeshBasicMaterial({ color: factionColors.pio.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  vig: new MeshBasicMaterial({ color: factionColors.vig.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  rip: new MeshBasicMaterial({ color: factionColors.rip.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  bor: new MeshBasicMaterial({ color: factionColors.bor.hexagonPlane, transparent: true, opacity: 0.25, side: SIDE }),
  undefined: new MeshBasicMaterial({ color: new Color(1.0, 1.0, 1.0), transparent: true, opacity: 0.25, side: SIDE }),
  mix: new MeshBasicMaterial({ color: new Color(1.0, 1.0, 1.0), transparent: true, opacity: 0.25, side: SIDE }),
};

export const factory = new MeshBasicMaterial({ color: 0x00FF00, side: SIDE, transparent: true, opacity: 0.5 });
